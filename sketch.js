...
var thunder1,thunder2,thunder3,thunder4,thun;

function preload(){
    thun1 = loadImage("RainyImages/thunderbolt/1.png")
    thun2 = loadImage("RainyImages/thunderbolt/2.png")
    thun3 = loadImage("RainyImages/thunderbolt/3.png")
    thun4 = loadImage("RainyImages/thunderbolt/4.png")
}
...
function thunder() {
    ...
    thun3 = loadImage("RainyImages/thunderbolt/3.png")
    thun4 = loadImage("RainyImages/thunderbolt/4.png")
    if (frameCount % floor(random(200)) === 0) {
